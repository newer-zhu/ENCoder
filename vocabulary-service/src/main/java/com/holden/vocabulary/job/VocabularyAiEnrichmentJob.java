...
import com.holden.vocabulary.service.AiVocabularyService;
...
public class VocabularyAiEnrichmentJob {
    ...
    public void enrichVocabulary() {
        try {
            ...
            log.error("run enrichVocabulary job failed", e);
        }
    }

    @Transactional(rollbackFor = Exception.class)
    public void doJob() throws ExecutionException, InterruptedException {
        ...
        // 调用 AI
        List<AiVocabularyResult> vocabularyResults = aiVocabularyService.enrichBatchAsync(
                new AiVocabularyEnrichRequest(promptTemplate, wordList, ctx)).get();
